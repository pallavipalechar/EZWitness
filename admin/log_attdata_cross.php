...
<?php
    ...
    if (isset($_GET['eid'])) 
    {
        ...
        $sdname=$rowsd['fname'];
        $search = "SELECT * FROM `gen_attendance_cross`  WHERE `eid`='$ird' and gdate between '$fdate' and '$tdate' order by id desc";
       
    }else
    {
        $search = "SELECT * FROM `gen_attendance_cross`  WHERE gdate between '$fdate' AND '$tdate' order by id desc" ;
    }
