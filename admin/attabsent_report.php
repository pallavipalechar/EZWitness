...
<body onload="printfun()" style="font-family: Arial, Helvetica, sans-serif;">
	<div class="container">
            <!-- Sidebar Holder -->
            <center>
           <h1>All Shift Absent Report Of Monthly Attendance</h1>
...
$count="1";
		...
		if ($rocount>0) 
		{
			$search="SELECT * FROM `emp_details` WHERE `eid` NOT IN (SELECT Employee_ID FROM attendance WHERE date(`Date`)=date('".$fromdate."')) order by dep_description";
