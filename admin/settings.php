...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $config_data = [
        'rtsp_url_cam' => $_POST["rtsp_url_cam"],
        'database' => $_POST["database"],
        'database_bw' => $_POST["database_bw"],
        'localsite' => $_POST["localsite"],
        'detected_img' => $_POST["detected_img"],
        'log_data' => $_POST["log_data"],
        'main_display_img' => $_POST["main_display_img"],
        'log_unimg' => $_POST["log_unimg"],
        'startimgpath' => $_POST["startimgpath"],
        'font_2fr' => $_POST["font_2fr"],
        'font_3fr' => $_POST["font_3fr"],
        'font_fr' => $_POST["font_fr"],
        'xml_file' => $_POST["xml_file"],
        'detector_name' => $_POST["detector_name"],
        'detector_name_train' => $_POST["detector_name_train"],
        'pkl_file' => $_POST["pkl_file"],
        'in_port' => $_POST["in_port"],
        'in_ip' => $_POST["in_ip"],
        'out_port' => $_POST["out_port"],
        'out_ip' => $_POST["out_ip"],
        'in_screen_name' => $_POST["in_screen_name"],
        'out_screen_name' => $_POST["out_screen_name"],
    ];
    ...
    $file_handle = fopen($new_config_file, 'w');
    ...
    fclose($file_handle);
    chmod($new_config_file, 0777);

    $success_message = "<p>System settings updated successfully!</p>";
...
<head>
    ...
    <title>Change System settings</title>
    <!-- Bootstrap CSS CDN -->
            ...
            <div id="content">
                <div class="row">
                    <div class="col-lg-12"><br>
                            ...
                            <div class="panel-heading"><h4>Add Camera</h4></div>
