...
git clone -b master https://ezwitnessmlr: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@github.com/ezwitnessmlr/brevera_backup.git

# Step 2: Navigate to the directory with the zip files
cd /opt/lampp/htdocs/ez/python/brevera_backup/cam2/
...
# Step 5: Set full read and write permissions to the extracted files
chmod -R 777 /opt/lampp/htdocs/ez/python/database_bw/

# Step 6: Clean up by removing the cloned repository (if not needed)
